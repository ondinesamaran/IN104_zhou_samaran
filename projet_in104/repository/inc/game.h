...
class Game : public sf::Drawable
{
    ...
    void addPod(int j1, int j2); //can add various arguments here to chose the apparence or the decision making type of the pod
    void updatePhysics();   //calcule la vitesse et la position en fonction de la decision prise
